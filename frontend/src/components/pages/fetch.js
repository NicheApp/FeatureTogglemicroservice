...
//
//		const result = await axios.get("http://localhost:8080/toggle/getfeatures");
		//alert(result.customkey);
...
//		loadFeatures();
	...
	return (
		...
		<div className="b"><Link className ="btn btn-primary btn-lg" to={`/fonly`}>Add A Feature</Link></div> 
